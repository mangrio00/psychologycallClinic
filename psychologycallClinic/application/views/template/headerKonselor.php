  ...
  <nav class="navbar navbar-fixed-top">
      <div class="container">
          ...
          <li class="dropdown pull-right">
              ...
              <li class="dropdown-item"><a href="<?= base_url(); ?>welcome/adminKonselor">Profile</a></li>
              <li class="dropdown-item"><a href="<?= base_url(); ?>welcome/adminReservasi">List Schedule</a></li>
