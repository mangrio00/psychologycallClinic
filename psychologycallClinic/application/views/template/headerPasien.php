      ...
      <ul class="nav navbar-nav navbar-right text-center">
        <li class="dropdown pull-right">
          ...
          <ul class="dropdown-menu">
            <li class="dropdown-item"><a href="<?= base_url(); ?>PasienC/">Account</a></li>
            <li class="dropdown-item"><a href="<?= base_url(); ?>pasienC/tambahReservasi/<?= $pasien['id_pasien'] ?>">Make Reservation</a></li>
