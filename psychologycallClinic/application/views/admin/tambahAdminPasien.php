                    ...
                    <div class="card-body" style="width: 500px;background-color:white;padding:3rem">
                        <form method="POST" action="#">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="firstname" placeholder="Fisrt Name" name="firstname" value="<?= set_value('firstname') ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="dob" placeholder="DOB" name="dob" value="<?= set_value('dob') ?>">
                            </div>
                            <div class="form-group">
