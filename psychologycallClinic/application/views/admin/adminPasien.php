      ...
      <table class="table">
        ...
        <tbody>
          <tr><?php
              ...
              <td class="text-center">
                <a href="<?= base_url(); ?>AdminC/hapusPasien/<?= $p['id_pasien'] ?>" class="btn btn-danger btn-sm float-center" onclick="return confirm('Apakah anda yakin menghapus data ini?');" ?><img src="https://www.freeiconspng.com/uploads/trash-can-icon-24.png" width="20" alt="Icon Drawing Trash Can" /></a>
